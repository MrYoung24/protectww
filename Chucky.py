...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='ECSBvr7ctz3CtxoVWuLb.hvwUQOUgplm49oJ9ENyBsW.tstMVbWu3ZPv588kAOFNX0y9DLGhEJT31oWLwwJBmwI=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='ECaPkKgGqkeGhmEyqwV0.SvLpOnovNRGQXZz1vb1/4a.knug5SD67H5Dk2MVLKC2slxkC8duf+CbLArIllkJRZQ=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='ECc1zkS1OGxY3aJ8q9F2.VfA4+AjEEhLC4vEqwN+M8G.ZJPUqNnos2+A/VUNiv6Gd0l6RYG2Esec8EQGIqAhpMA=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='ECd7quIFDJzBXZ7QaPE8.j9Z4M858H0CqCWhNTejoca.PnALNFuISDj3uex1Lv8k60ltt3W/CqAGJV4qYu4IhPo=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EC8p0R22F0Ic8tPNX397.+T+wGz1J/snqb8Q2IkZR5W.agllyNe2huKBP63XaABzjR9AlT1uCxjlKl564Qzrkig=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EC3CoVbN830Y6Gcqqu78.MFGfNIKKZ6DrNIzPgZY7Ea.N1Jju1J8wnhyhuryRk4HcwnALom//2rozrsDWOKs8Ao=')
km.loginResult()
...
Young masih tampan saja
"""
tjia="u1d55aeaa8b863cb338f4e8fd7a761b4b"
...
✓ Ghost on/off
✓ Invitepro on/off
Grup aja saya jaga apalagi kamu :)✓✓
"""
...
Creator=["u1d55aeaa8b863cb338f4e8fd7a761b4b"]
admin=["u1d55aeaa8b863cb338f4e8fd7a761b4b","u23ad5ddec0dd0523f9caffad673d693c","u8b2bb5214c1afc77d06901a535c23e30","u57a54b914085fea6f04c19f6fe589057","u94fb89525397a12a24df3642a7335fe7","u3a43893bf65289be03f9fd3a85dab2a7","u787d28e13bd4f94cdca5457cd90efaf4","u86304883a6fa105778bfdf13f467eaf0"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Like done bosq jangan ngemis lagi",
    "comment2":"Sampah ngemis like truss",
    "comment3":"Bacot intinya Saya Tampan",
    "comment4":"123 Saya Memang Tampan",
    "comment5":"Bot Auto Like ©By : Young\nContact Me : 👉 line.me/ti/p/~aduhhlupa.",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Young")
...
#		    cl.sendText(msg.to,"Khusus Young")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u1d55aeaa8b863cb338f4e8fd7a761b4b"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                try:
                    ...
                    Young = text1[0].replace("s150x150/","")
                    user = "Name: " + text[-2] + "\n"
                    ...
                    cl.sendImageWithURL(msg.to, Young)
